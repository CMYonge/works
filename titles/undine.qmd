---
title: "Undine - with Introduction by Charlotte Mary Yonge"
sort_title: "Undine - with Introduction by Charlotte Mary Yonge"
slug: "undine"
format:
  html:
    toc: true
...
### **Online text of*Undine***

[Click here to reach the latest version of***Undine***from Gutenberg  
](http://promo.net/cgi-promo/pg/t9.cgi?entry=2825&full=yes&ftpsite=ftp://ibiblio.org/pub/docs/books/gutenberg/)(Many thanks to Sandra Laythorpe and her team for another magnificent effort)

### **Summary of*Undine***

Read a summary of*Undine*on the**[History of Mermaids](http://rubens.anu.edu.au/student.projects/mermaids/faerietales.html#Undine)**website.

**Charlotte Yonge's Introduction to*Undine***

*(extract from the*[***Gutenberg online edition of Undine***](http://promo.net/cgi-promo/pg/t9.cgi?entry=2825&full=yes&ftpsite=ftp://ibiblio.org/pub/docs/books/gutenberg)*)*

#### Introduction

Four tales are, it is said, intended by the Author to be appropriate to the Four Seasons: the stern, grave "[Sintram](sintram.qmd)", to winter; the tearful, smiling, fresh "Undine", to Spring; the torrid deserts of the "[Two Captains](http://promo.net/cgi-promo/pg/t9.cgi?entry=2826&full=yes&ftpsite=ftp://ibiblio.org/pub/docs/books/gutenberg/)", to summer; and the sunset gold of "[Aslauga's Knight](http://promo.net/cgi-promo/pg/t9.cgi?entry=2827&full=yes&ftpsite=ftp://ibiblio.org/pub/docs/books/gutenberg/)", to autumn. Of these two are before us.
...
May we mention that Miss Christabel Coleridge's "Waynflete" brings something of the spirit and idea of "[Sintram](sintram.qmd)" into modern life?
...
#### Undine, a story by La Motte Fouque, published in German in 1811 and first translated ito English in 1818.
...
The story, which has resemblences the THE LITTLE MERMAID by Andersen, is descended from Melusine, the French folk-tale of a water-sprite who who marries a knight on condition that he shall never see her on Saturdays, when she resumes her mermaid shape. Undine has been made ito a ballet and an opera.

An unabridged English edition of the story published in 1909 has fine illustrations by Rackhan. George Macdonald thought Undine 'the most beautiful' of all fairy stories, and the references to it in such works as Charlotte Yonge's THE DAISY CHAIN and Louisa Alcott's LITTLE WOMEN show that it was one of the best loved of all books for many 19th-century children."
